...
class PoseFeatures(BaseModel):
    ...
    # --- Speed / rate-of-change metrics ---
    body_speed: float = 0.0            # CoG descent speed (units/sec), positive = falling
    angle_change_rate: float = 0.0     # body axis angle change (deg/sec), positive = tilting
